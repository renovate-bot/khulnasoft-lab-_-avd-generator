...
import (
	...
	"github.com/khulnasoft-lab/tracker/tracker-rules/engine"
	"github.com/khulnasoft-lab/tracker/tracker-rules/signatures/rego/regosig"
...
func OnEventSpec(t *testing.T, target string, partial bool) {
	testCases := []struct {
	...
	}{
		{
			...
			event: tracker.Event{
				Args: []tracker.Argument{
					{
						ArgMeta: tracker.ArgMeta{
							Name: "doesn't matter",
						},
						Value: "ends with yo",
					},
